...
const Wallet = ({ onBack }) => {
  ...
  return (
    ...
    >
      ...
      >
        <Box
          component="img"
          src="https://www.omlet.nl/images/cache/1024/682/Dog-Japanese_Shiba_Inu-Two_healthy_adult_Japanese_Shiba_Inus_standing_tall_together.jpg"
          sx={{
            position: 'absolute',
            width: '100%',
            height: '100%',
      ...
      >
       ...
       <Typography sx={{ fontFamily, fontWeight: 600, fontSize: 10, mb: 1, color: 'red' }}>
        скоро Electron можно будет обменять на atoms и наоборот
      </Typography>
  ...
  // Добавляем slice().reverse() для обратного порядка
